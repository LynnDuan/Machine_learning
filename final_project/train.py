...
parser.add_argument('--steps_1', type=int, default=90000)#default=90000)
parser.add_argument('--steps_2', type=int, default=10000)#default=10000)
parser.add_argument('--steps_3', type=int, default=400000)#default=400000)
parser.add_argument('--snaperiod_1', type=int, default=18000)#default=18000)
parser.add_argument('--snaperiod_2', type=int, default=2000)#default=2000)
parser.add_argument('--snaperiod_3', type=int, default=80000)#default=80000)
